...
function createSimpleStore(initialState, actionsMap, additionalProps) {
    ...
    var asyncActionsMap = ((_a = additionalProps) === null || _a === void 0 ? void 0 : _a.thunks) || [];
    var options = ((_b = additionalProps) === null || _b === void 0 ? void 0 : _b.options) || { cache: { location: '', key: '' } };
    ...
    var useReduxDevtools = function (name, handleDispatchReduxDevtools) {
        var _a, _b;
        var reduxDevtoolsExtension = React.useRef((_b = (_a = window) === null || _a === void 0 ? void 0 : _a.__REDUX_DEVTOOLS_EXTENSION__, (_b !== null && _b !== void 0 ? _b : null)));
    ...
    var Provider = function (_a) {
        ...
        var handleDispatchReduxDevtools = useCallback(function (_a) {
            ...
            switch (payload.type) {
                ...
                case 'JUMP_TO_STATE':
                case 'JUMP_TO_ACTION':
                    var _ = reducerDispatch({ type: '__REDUX_DEVTOOLS_RELOAD__', payload: JSON.parse(state) });
            }
        }, []);
...
function _getInitialState(_a) {
    ...
    var _b, _c, _d, _e;
    if (((_b = cache) === null || _b === void 0 ? void 0 : _b.key) && ((_c = cache) === null || _c === void 0 ? void 0 : _c.location) === 'LOCALSTORAGE') {
        var state = localStorage.getItem(cache.key);
        if (state && state !== 'undefined')
            return JSON.parse(state);
    }
    if (((_d = cache) === null || _d === void 0 ? void 0 : _d.key) && ((_e = cache) === null || _e === void 0 ? void 0 : _e.location) === 'SESSIONSTORAGE') {
